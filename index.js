...
// const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.eg4ok.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority`;
// const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true });


// const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.kk00x.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority`;
// const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true });
...
client.connect(err => {
    ...
    const reviewCollection = client.db("toynew").collection("review");
    const serviceCollection = client.db("toynew").collection("services");
    const orderCollection = client.db("toynew").collection("orders");
    const adminCollection = client.db("toynew").collection("admin");
